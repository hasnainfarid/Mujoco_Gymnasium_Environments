"""
Setup script for Humanoid Soccer Environment package.
"""
...
def read_readme():
    ...
    if os.path.exists(readme_path):
        with open(readme_path, 'r', encoding='utf-8') as f:
            return f.read()
    return "A MuJoCo-based humanoid soccer environment for reinforcement learning."

# Package metadata
PACKAGE_NAME = "humanoid_soccer_env"
VERSION = "1.0.0"
AUTHOR = "Hasnain Fareed"
AUTHOR_EMAIL = "hasnain.fareed@example.com"
DESCRIPTION = "MuJoCo-based humanoid soccer environment for reinforcement learning"
LICENSE = "MIT"
YEAR = "2025"
...
setup(
    ...
    entry_points={
        'console_scripts': [
            f'{PACKAGE_NAME}-test=humanoid_soccer_env.test_soccer:main',
        ],
    },
